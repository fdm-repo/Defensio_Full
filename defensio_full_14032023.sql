...
(1, 'HomeAdry', 'wmEgi9sSxLIl', 'Istrana', '2023-03-13 22:43:54', '2023-03-13 22:43:54', '2023-03-13 22:43:55', '2023-03-13 22:43:56', '133', 'ERR_C2_OFF', 'ERR_C2_OFF', 'ERR_C2_OFF', 'ERR_C2_OFF', 'ERR_C2_OFF', 'on'),
...
--
-- Table structure for table `suricata_banned`
--

CREATE TABLE `suricata_banned` (
  `id_banned` int(11) NOT NULL,
  `signature_banned` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Indexes for table `suricata_banned`
--
ALTER TABLE `suricata_banned`
...
--
-- AUTO_INCREMENT for table `suricata_banned`
--
ALTER TABLE `suricata_banned`
  MODIFY `id_banned` int(11) NOT NULL AUTO_INCREMENT;
